...
function add_theme_scripts() {
	...
	wp_enqueue_style( 'foundation', get_template_directory_uri() . '/foundation.css', '', $rand );
	wp_enqueue_style( 'menu', get_template_directory_uri() . '/menu.css', '', $rand );
}
...
function store_mall_wc_empty_cart_redirect_url() {
        $url = 'https://worhead.com/store/'; // change this link to your need
        return esc_url( $url );
    }
add_filter( 'woocommerce_return_to_shop_redirect', 'store_mall_wc_empty_cart_redirect_url' );

// move coupom box on checkout
